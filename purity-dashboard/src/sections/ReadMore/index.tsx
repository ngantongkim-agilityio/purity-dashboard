...
export const ReadMore = () => {
  return (
    <div className='flex justify-between gap-6'>
      <div className='w-7/12 flex justify-between w-full bg-primary-100 rounded-xl p-4 shadow-secondary-50 shadow-md'>
      ...
      <div className='w-5/12 bg-primary-100 rounded-xl p-4 shadow-secondary-50 shadow-md'>
