  ...
  return (
    <aside className='flex h-full flex-col p-8 min-w-[310px] space-y-6'>
      ...
      <div className='flex grow flex-row justify-between space-x-4 md:flex-col md:space-x-0 md:space-y-2'>
        ...
        <div>
          <button
            className='flex h-[48px] w-full grow items-center justify-center gap-2 rounded-md bg-transparent text-secondary-300 p-3 text-sm font-medium hover:text-black md:flex-none md:justify-start md:p-2 md:px-3'
            onClick={handleSignOut}
          >
            <PowerIcon customClass='w-6 h-6' />
            <Text className='text-transparent text-secondary-300'>
              Sign Out
            </Text>
          </button>
        </div>
